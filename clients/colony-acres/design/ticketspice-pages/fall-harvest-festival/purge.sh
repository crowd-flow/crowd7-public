#!/usr/bin/env bash
# Purge jsDelivr's edge cache for the Colony Acres fall-harvest-festival page.
...
REF="master"
BASE_PATH="clients/colony-acres/design/ticketspice-pages/fall-harvest-festival"
STEM="fall-harvest-festival-2026.html"
