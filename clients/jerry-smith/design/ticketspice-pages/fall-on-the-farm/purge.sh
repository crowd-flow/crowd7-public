#!/usr/bin/env bash
# Purge jsDelivr's edge cache for the Jerry Smith Fall on the Farm page.
...
REF="master"
BASE_PATH="clients/jerry-smith/design/ticketspice-pages/fall-on-the-farm"
STEM="fall-on-the-farm-2026.html"
