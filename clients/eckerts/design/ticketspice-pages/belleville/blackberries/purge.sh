#!/usr/bin/env bash
# Purge jsDelivr's edge cache for the Belleville blackberries page.
...
REF="master"
BASE_PATH="clients/eckerts/design/ticketspice-pages/belleville/blackberries"
STEM="belleville-farm-field-access-2026.blackberry-content.html"
