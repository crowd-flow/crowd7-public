#!/usr/bin/env bash
# Purge jsDelivr's edge cache for the Belleville Sunflower Festival page.
...
REF="master"
BASE_PATH="clients/eckerts/design/ticketspice-pages/belleville/sunflower-festival"
STEM="sunflower-festival-belleville-2026-content.html"
