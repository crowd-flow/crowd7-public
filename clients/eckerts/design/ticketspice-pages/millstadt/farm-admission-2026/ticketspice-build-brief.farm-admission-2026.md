...
1. **Family Bundle price — SUPERSEDED 2026-08-06, still not built.** The 7/29 Slack rule below (weekend price ×4, −25%) was itself superseded by Amanda's live 8/6 Eckert's check-in call (`meetings/2026/8.6.26.Crowd7EckertsCheckIn.transcript.md`), which finalized different, more specific numbers — **use these, not the 7/29 math**: **$58 flat**, framed as **33% off the Weekend Admission gate rate** ($22 gate × 4 = $88 → −33% ≈ $58.96, rounded to **$58.00**). Structure: sold/scanned as **4 individual unique QR codes** (not one ticket scanned 4×) — Amanda explicit: *"That would give them four separate QR codes though that they can scan individually... individual unique QR codes."* Buyer-facing display name is **"Family Bundle Admission"** via CSS relabel (not "Family Four Pack Bundle") — Amanda: *"I don't want them getting four unique QR codes that say family four pack bundle... I want them to say family bundle admission."* Weekend-only (Sat/Sun), no other extras bundled in. This also resolves the "promotional card or new ticket type" design question still open on ClickUp `86ajq797h` as of this write-up — **native TS ticket type**, per the call. (Stale 7/29 math, kept below for the record only: *"We talked about that these would be the Weekend price x 4 - with a 25% discount"* → online $17×4−25%=$51.00, gate $22×4−25%=$66.00 — **do not build to this number**, it predates the 8/6 finalization.) Bryan built the equivalent native "Friends and Family Bundle" ticket type for Versailles 8/12–8/13 — **after** the 8/6 call, so likely already on the correct $58/33%-off-gate logic (Amanda: *"same 33%-off-gate logic mirrors to Versailles/Kentucky"* per the dossier's 8/6 note) — worth Bryan double-checking Versailles' actual configured price against this spec while he's in there. **Millstadt's twin was never built**: no matching commit in this repo, no Slack confirmation, and the "excluded" fine-print (see content HTML) is still live as of the 8/27 file. Native TS ticket type still needs configuring: name "Family Bundle Admission," $58 flat, Weekend (Sat/Sun) dates only, 4 individual unique QR codes on purchase. Amanda's direct question (7/16, 06:34: *"Once we have the bundles firmed up, will we add a card for those?"*) can now be answered yes.
...
- [ ] Family Bundle Admission — price finalized 8/6 ($58 flat, 33% off Weekend/Sat-Sun $22 gate rate ×4, confirm-item #1) — configure as native TS ticket type: name "Family Bundle Admission," $58 flat, Sat/Sun only, 4 individual unique QR codes on purchase; still not built as of 2026-09-02
...
1. **Family Bundle Admission price — FINALIZED 8/6, needs Bryan to build.** $58 flat — 33% off the Weekend (Sat/Sun) $22 gate rate ×4 (supersedes the earlier 7/29 $51/$66 math). Sold as 4 individual unique QR codes, buyer-facing name "Family Bundle Admission." Native ticket type not yet configured — Versailles' equivalent card shipped 8/12–8/13 (after this call, so worth Bryan confirming it landed on the $58/33%-off-gate number). No reply-to-Amanda blocker remains and the card-vs-ticket-type question is settled (native ticket type); this is now a build task, not an open pricing/design question.
