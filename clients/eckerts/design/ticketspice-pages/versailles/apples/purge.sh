#!/usr/bin/env bash
# Purge jsDelivr's edge cache for the Eckert's Versailles apples (field-access) page.
...
#
# NOTE: the v8 hybrid loader for this page (Cloudflare Pages primary,
# jsDelivr fallback-leg-only) is instantiated but per TS-CDN-MIGRATION.md
# row 10 not yet pasted into the live TS page — so the CURRENTLY LIVE loader
# may still be pre-v8 (jsDelivr-primary). Run this until the v8 paste lands.
#
...
REF="master"
BASE_PATH="clients/eckerts/design/ticketspice-pages/versailles/apples"
STEM="versailles-farm-field-access-pass-2026.apple-content.html"
