#!/usr/bin/env bash
# Purge jsDelivr's edge cache for the Versailles peaches page.
...
REF="master"
BASE_PATH="clients/eckerts/design/ticketspice-pages/versailles/peaches"
STEM="versailles-farm-field-access-pass-2026.peach-content.html"
