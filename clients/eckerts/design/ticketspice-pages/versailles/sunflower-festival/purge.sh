#!/usr/bin/env bash
# Purge jsDelivr's edge cache for the Eckert's Versailles sunflower-festival page.
...
REF="master"
BASE_PATH="clients/eckerts/design/ticketspice-pages/versailles/sunflower-festival"
STEM="sunflower-festival-versailles-2026-content.html"
