#!/usr/bin/env bash
# Purge jsDelivr's edge cache for the Summers Farm Season Pass page.
...
REF="master"
BASE_PATH="clients/summers-farm/design/ticketspice-pages/season-pass"
STEM="season-pass-2026.html"
