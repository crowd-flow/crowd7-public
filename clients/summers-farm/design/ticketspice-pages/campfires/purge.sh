#!/usr/bin/env bash
# Purge jsDelivr's edge cache for the Summers Farm Campfires page.
...
REF="master"
BASE_PATH="clients/summers-farm/design/ticketspice-pages/campfires"
STEM="campfires-2026.html"
