#!/usr/bin/env bash
# Purge jsDelivr's edge cache for the Summers Farm Fall Festival page.
...
REF="master"
BASE_PATH="clients/summers-farm/design/ticketspice-pages/fall-festival"
STEM="fall-festival-2026.html"
